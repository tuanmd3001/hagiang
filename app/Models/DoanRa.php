 ...
 */
class DoanRa extends Model
{

    public $table = 'doan_ras';
    ...
    const ROUTE_NAME = [
        self::LEVEL_TINH => "doanRaCapTinh",
        self::LEVEL_HUYEN => "doanRaCapHuyen",
        self::LEVEL_XA => "doanRaCapXa"
    ];
    ...
    public function getTenNuocDiAttribute()
    {
        $quoc_gia = DmQuocGia::find($this->nuoc_di);
        if ($quoc_gia){
            return $quoc_gia->ten;
        }
        return "";
