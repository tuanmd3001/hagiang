...
class CanBoNgoaiGiaoTinhDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'can_bo_ngoai_giao_tinhs.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\CanBoNgoaiGiaoTinh $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(CanBoNgoaiGiaoTinh $model)
    {
    ...
    {
        return 'can_bo_ngoai_giao_tinhs_datatable_' . time();
    }
