...
class XncHcNgoaiGiaoDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ...
            ->addColumn('action', 'xnc_hc_ngoai_giaos.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\XncHcNgoaiGiao $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(XncHcNgoaiGiao $model)
    {
