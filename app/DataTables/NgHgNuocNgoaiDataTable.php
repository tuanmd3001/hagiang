...
class NgHgNuocNgoaiDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'ng_hg_nuoc_ngoais.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\NgHgNuocNgoai $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(NgHgNuocNgoai $model)
    {
    ...
    {
        return 'ng_hg_nuoc_ngoais_datatable_' . time();
    }
}
