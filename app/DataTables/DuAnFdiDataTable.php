...
class DuAnFdiDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'du_an_fdis.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DuAnFdi $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DuAnFdi $model)
    {
