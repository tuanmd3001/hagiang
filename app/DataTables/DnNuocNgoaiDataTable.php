...
class DnNuocNgoaiDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'dn_nuoc_ngoais.datatables_actions');
     ...
     *
     * @param \App\Models\DnNuocNgoai $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DnNuocNgoai $model)
    {
    ...
    {
        return 'dn_nuoc_ngoais_datatable_' . time();
    }
