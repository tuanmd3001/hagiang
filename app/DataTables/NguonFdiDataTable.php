...
class NguonFdiDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'nguon_fdis.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\NguonFdi $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(NguonFdi $model)
    {
    ...
    {
        return 'nguon_fdis_datatable_' . time();
    }
