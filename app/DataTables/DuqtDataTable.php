...
class DuqtDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ...
            ->editColumn('loai_van_ban', function ($temp){
                return Duqt::TYPE_LABEL[$temp['loai_van_ban']];
            })
            ->editColumn('tinh_trang_hieu_luc', function ($temp){
                return Duqt::STATUS_LABEL[$temp['tinh_trang_hieu_luc']];
            })->addColumn('action', 'duqts.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\Duqt $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Duqt $model)
    {
    ...
    protected function getColumns()
    {
        return [
            ...
            ['name' => 'ten_nuoc_ky', 'data' => 'ten_nuoc_ky', 'title' => 'Nước ký'],
            ...
            ['name' => 'ky_nhan_doan_cap_cao', 'data' => 'ky_nhan_doan_cap_cao', 'title' => 'Ký nhân doàn cấp cao'],
            ['name' => 'trong_kh', 'data' => 'trong_kh', 'title' => 'Hoạt động trong kế hoạch', 'className' => 'text-center'],
