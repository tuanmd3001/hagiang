...
class DmToChucDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'danhMuc.to_chuc.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DmToChuc $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DmToChuc $model)
    {
    ...
    {
        return 'to_chuc_datatable_' . time();
    }
}
