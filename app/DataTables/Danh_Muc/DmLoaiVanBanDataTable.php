...
class DmLoaiVanBanDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'danhMuc.loai_van_ban.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DmLoaiVanBan $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DmLoaiVanBan $model)
    {
    ...
    {
        return 'loai_van_ban_datatable_' . time();
    }
}
