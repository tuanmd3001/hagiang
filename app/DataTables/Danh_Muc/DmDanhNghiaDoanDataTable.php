...
class DmDanhNghiaDoanDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'danhMuc.danh_nghia_doan.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DmDanhNghiaDoan $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DmDanhNghiaDoan $model)
    {
    ...
    {
        return 'danh_nghia_doan_datatable_' . time();
    }
}
