...
class DmLoaiHangHoaDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'danhMuc.loai_hang_hoa.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DmLoaiHangHoa $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DmLoaiHangHoa $model)
    {
    ...
    {
        return 'loai_hang_hoa_datatable_' . time();
    }
}
