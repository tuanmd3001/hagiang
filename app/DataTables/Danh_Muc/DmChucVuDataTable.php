...
class DmChucVuDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'danhMuc.chuc_vu.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DmChucVu $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DmChucVu $model)
    {
    ...
    {
        return 'chuc_vu_datatable_' . time();
    }
}
