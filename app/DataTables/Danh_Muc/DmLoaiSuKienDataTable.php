...
class DmLoaiSuKienDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'danhMuc.loai_su_kien.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DmLoaiSuKien $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DmLoaiSuKien $model)
    {
    ...
    {
        return 'loai_su_kien_datatable_' . time();
    }
}
