...
class DmLoaiDuAnDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'danhMuc.loai_du_an.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DmLoaiDuAn $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DmLoaiDuAn $model)
    {
    ...
    {
        return 'loai_du_an_datatable_' . time();
    }
}
