...
class DmNgheNghiepDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'danhMuc.nghe_nghiep.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DmNgheNghiep $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DmNgheNghiep $model)
    {
    ...
    {
        return 'nghe_nghiep_datatable_' . time();
    }
}
