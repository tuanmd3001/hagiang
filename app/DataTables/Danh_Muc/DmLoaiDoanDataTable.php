...
class DmLoaiDoanDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'danhMuc.loai_doan.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DmLoaiDoan $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DmLoaiDoan $model)
    {
    ...
    {
        return 'loai_doan_datatable_' . time();
    }
}
