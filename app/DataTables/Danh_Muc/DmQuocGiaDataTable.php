...
class DmQuocGiaDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'danhMuc.quoc_gia.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DmQuocGia $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DmQuocGia $model)
    {
    ...
    {
        return 'quoc_gia_datatable_' . time();
    }
}
