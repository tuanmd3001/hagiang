...
class DmLoaiHinhToChucDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'danhMuc.loai_hinh_to_chuc.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DmLoaiHinhToChuc $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DmLoaiHinhToChuc $model)
    {
    ...
    {
        return 'loai_hinh_to_chuc_datatable_' . time();
    }
}
