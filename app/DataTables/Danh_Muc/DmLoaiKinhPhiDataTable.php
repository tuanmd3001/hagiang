...
class DmLoaiKinhPhiDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'danhMuc.loai_kinh_phi.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DmLoaiKinhPhi $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DmLoaiKinhPhi $model)
    {
    ...
    {
        return 'loai_kinh_phi_datatable_' . time();
    }
}
