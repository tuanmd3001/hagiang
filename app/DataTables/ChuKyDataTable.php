...
class ChuKyDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->editColumn('file', function ($temp){
                return "<img class='img_chu_ky' src='".$temp->file."'>";
            })
            ->addColumn('action', 'chu_kies.datatables_actions')
     ...
     *
     * @param \App\Models\ChuKy $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(ChuKy $model)
    {
    ...
    protected function getColumns()
    {
        return [
            ...
            ['name' => 'file', 'data' => 'file', 'title' => 'Chữ ký, con dấu', 'className' => 'text-center']
        ];
    }
    ...
    {
        return 'chu_kies_datatable_' . time();
    }
