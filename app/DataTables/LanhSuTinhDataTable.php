...
class LanhSuTinhDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'lanh_su_tinhs.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\LanhSuTinh $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(LanhSuTinh $model)
    {
