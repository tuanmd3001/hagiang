...
class NguonOdaDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'nguon_odas.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\NguonOda $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(NguonOda $model)
    {
    ...
    {
        return 'nguon_odas_datatable_' . time();
    }
