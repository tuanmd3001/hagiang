...
class HcNgoaiGiaoDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ...
            ->addColumn('action', 'hc_ngoai_giaos.datatables_actions')
     ...
     *
     * @param \App\Models\HcNgoaiGiao $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(HcNgoaiGiao $model)
    {
    ...
    {
        return 'hc_ngoai_giaos_datatable_' . time();
    }
}
