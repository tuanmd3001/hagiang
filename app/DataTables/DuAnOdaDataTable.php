...
class DuAnOdaDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'du_an_odas.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DuAnOda $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DuAnOda $model)
    {
    ...
    {
        return 'du_an_odas_datatable_' . time();
    }
