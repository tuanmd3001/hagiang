...
class LanhSuNuocNgoaiDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'lanh_su_nuoc_ngoais.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\LanhSuNuocNgoai $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(LanhSuNuocNgoai $model)
    {
    ...
    {
        return 'lanh_su_nuoc_ngoais_datatable_' . time();
    }
