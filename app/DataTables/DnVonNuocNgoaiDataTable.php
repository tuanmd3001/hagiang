...
class DnVonNuocNgoaiDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addIndexColumn()
            ->addColumn('action', 'dn_von_nuoc_ngoais.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\DnVonNuocNgoai $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DnVonNuocNgoai $model)
    {
